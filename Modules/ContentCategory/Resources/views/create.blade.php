...
{{--        {--}}
{{--            document.getElementById('captcha_error').classList().remove('d-none').add('d-inline')--}}
{{--        }--}}
{{--    </script>--}}
{{--    {!! htmlScriptTagJsApi() !!}--}}
    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <h5 class="bg-danger d-none text-white rounded" id="captcha_error">اعتبار سنجی کپچا با خطا مواجه شد</h5>
