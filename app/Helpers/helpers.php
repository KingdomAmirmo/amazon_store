...
function jalaiDate($date, $format = '%A, %d %B %Y H:i:s')
{
...
function validateNationalCode($nationalCode)
{
    ...
    $bannedArray = ['0000000000', '1111111111', '2222222222', '3333333333', '4444444444', '5555555555', '6666666666', '7777777777', '8888888888', '999999999'];
    ...
    elseif (in_array($nationalCode, $bannedArray)) {
        ...
        $devideRemaining = $sum % 11;

        if ($devideRemaining < 2) {
            $lastDigit = $devideRemaining;
        }
        else {
            $lastDigit = 11 - ($devideRemaining);
        }
