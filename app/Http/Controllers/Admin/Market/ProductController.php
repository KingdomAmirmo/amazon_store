...
class ProductController extends Controller
{
    ...
    public function store(ProductRequest $request, ImageService $imageService)
    {
        ...
        return redirect()->route('admin.market.product.index')->with('swal-success', "کالا شما با موفقیت ثبت شد");
    }
    ...
    public function update(ProductRequest $request, Product $product, ImageService $imageService)
    {
        ...
        return redirect()->route('admin.market.product.index')->with('swal-success', 'کالا شما با موفقیت ویرایش شد');
    ...
    public function destroy(Product $product)
    {
        ...
        return redirect()->route('admin.market.product.index')->with('swal-success', 'کالا با موفقیت حذف شد');
