...
class StoreController extends Controller
{
    ...
    public function update(StoreUpdateRequest $request, Product $product)
    {
        ...
        //forUpdating sold_number
        $product_sold_number = Product::where('id', $product->id)->first();
        $product_sold_number->sold_number = $inputs['sold_number'];
        $product_sold_number->save();
