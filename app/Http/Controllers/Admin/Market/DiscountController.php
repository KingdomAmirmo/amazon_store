...
class DiscountController extends Controller
{
    ...
    public function copanStore(CopanRequest $request){
        ...
        //forChange(user_id)
        $selected_copan = Copan::where('id', $copan->id)->first();
        $selected_copan->user_id = $request->user_id;
        $selected_copan->save();
    ...
    public function copanDestroy(Copan $copan){
        $copan->delete();
        return redirect()->route('admin.market.discount.copan')->with('swal-success', "کد تخفیف موردنظر با موفقیت حذف شد");
    }
    ...
    public function commonDiscountUpdate(CommonDiscountRequest $request, CommonDiscount $commonDiscount){
        ...
        return redirect()->route('admin.market.discount.commonDiscount')->with('swal-success', "تخفیف عمومی شما با موفقیت ویرایش شد");
    }
    public function commonDiscountDestroy(CommonDiscount $commonDiscount){
        $commonDiscount->delete();
        return redirect()->route('admin.market.discount.commonDiscount')->with('swal-success', "تخفیف عمومی موردنظر با موفقیت حذف شد");
    }
    ...
    public function amazingSaleDestroy(AmazingSale $amazingSale){
        $amazingSale->delete();
        return redirect()->route('admin.market.discount.amazingSale')->with('swal-success', "تخفیف شگفت انگیز موردنظر با موفقیت حذف شد");
    }
