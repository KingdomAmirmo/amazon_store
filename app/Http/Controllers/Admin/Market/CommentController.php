...
class CommentController extends Controller
{
    ...
    public function index()
    {
        ...
        $comments = Comment::orderBy('created_at')->where('commentable_type', 'App\Models\Market\Product')->simplePaginate(10);
    ...
    public function status(Comment $comment)
    {
        ...
        return redirect()->route('admin.market.comment.index')->with('swal-success', 'کامنت مورد نظر' . ' ' . $status . ' ' . 'شد ');
    ...
    public function answer(CommentRequest $request, Comment $comment)
    {
        if ($comment->parent_id == null)
        {
            ...
            return redirect()->route('admin.market.comment.index')->with('swal-success', 'پاسخ شما باموفقیت ثبت شد');
        }else{
