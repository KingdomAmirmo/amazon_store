...
class TicketController extends Controller
{
    ...
    public function answer(TicketRequest $request, Ticket $ticket)
    {
        ...
        return redirect()->route('admin.ticket.index')->with('swal-success', 'پاسخ شما باموفقیت ثبت شد');
...
//        dd($ticket);
        ...
        $result = $ticket->save();
        return redirect()->route('admin.ticket.index')->with('swal-success', 'تغییر وضعیت تیکت با موفقیت انجام شد');
