...
(function(factory) {
    ...
    var S2 = (function() {
        ...
        // Needed mostly in the language images, where the loader is not inserted
                    ...
                    if (typeof language === 'string') {
                        try {
                            ...
                            try {
                                ...
                                // because of how Select2 helps load all possible translation images
                                if (debug && window.console && console.warn) {
                                    console.warn(
                                        'Select2: The language image for "' + language + '" could ' +
