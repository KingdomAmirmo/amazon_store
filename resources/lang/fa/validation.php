...
return [
    ...
    */
    ...
    "between"          => [
        ...
        "image"    => ":attribute باید بین :min و :max کیلوبایت باشد.",
    ...
    "max"              => [
        ...
        "image"    => "حجم :attribute نباید بیشتر از :max کیلوبایت باشد.",
    ...
    "min"              => [
        ...
        "image"    => ":attribute نباید کوچکتر از :min کیلوبایت باشد.",
...
//    "required_with"    => ":attribute الزامی است زمانی که :values موجود است.",
    ...
    "size"             => [
        ...
        "image"    => ":attribute باید برابر با :size کیلوبایت باشد.",
    ...
    */
    'attributes' => [
        ...
        "percentage"                => "درصد",
        "discount_celling"          => "سقف تخفیف",
        "minimal_order_amount"      => "حداقل مبلغ",
        "product_id"                => "کالا",
        "code"                      => "کد تخفیف",
        "user_id"                   => "کاربر",
        "type"                      => "نوع کوپن",
        "discount_ceiling"          => "سقف تحفیف",
        "otp"                       => "رمز یکبار مصرف",
        "color"                     => "رنگ",
        "color_name"                => "نام رنگ",
