                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div>
                                    ...
                                    <select name="brand_id" id="" class="form-control form-control-sm">
                                        <option>برند کالا را انتخاب کنید</option>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="published_at" id="published_at" class="form-control form-control-sm d-none" value="{{ $product->published_at }}">
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-control-sm" name="introduction" id="introduction" cols="30" rows="6">
...
{{-- for duplicate Features and Value   --}}
    <script>
        $(function (){
