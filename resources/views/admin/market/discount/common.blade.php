                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($commonDiscounts as $commonDiscount)
                            <tr>
                                ...
                                <td>{{ jalaiDate($commonDiscount->start_date) }}</td>
                                <td>{{ jalaiDate($commonDiscount->end_date) }}</td>
                                <td class="text-center"><span class="bg-primary rounded-circle text-white font-weight-bold p-1">{{ $commonDiscount->status == 0 ? "غیرفعال" : "فعال" }}</span></td>
