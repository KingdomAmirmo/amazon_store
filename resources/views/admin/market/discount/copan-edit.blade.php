                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="start_date" id="start_date" class="form-control form-control-sm d-none" value="{{ $copan->start_date }}">
                            ...
                            <section class="col-12 col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="end_date" id="end_date" class="form-control form-control-sm d-none" value="{{ $copan->end_date }}">
