                    ...
                    <form action="{{ route('admin.market.discount.commonDiscount.update', $commonDiscount->id) }}" method="Post">
                        ...
                        <section class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="percentage" value="{{old('percentage', $commonDiscount->percentage)}}" class="form-control form-control-sm">
                                </div>
                                    @error('percentage')
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="start_date" id="start_date" class="form-control form-control-sm d-none" value="{{ $commonDiscount->start_date }}">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="end_date" id="end_date" class="form-control form-control-sm d-none" value="{{ $commonDiscount->end_date }}">
