                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($amazingSales as $amazingSale)
                            <tr>
                                ...
                                <td>{{ jalaiDate($amazingSale->start_date) }}</td>
                                <td>{{ jalaiDate($amazingSale->end_date) }}</td>
                                <td class="text-center"><span class="bg-primary rounded-circle text-white font-weight-bold p-1">{{ $amazingSale->status == 0 ? "غیرفعال" : "فعال" }}</span></td>
