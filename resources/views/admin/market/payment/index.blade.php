        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="{{ route('admin.market.brand.create') }}" class="btn btn-info btn-sm disabled">پرداخت جدید</a>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($payments as $payment)
                            <tr>
                                ...
                                <td> @if($payment->type == 0) آنلاین @elseif($payment->type == 1) آفلاین @else درمحل @endif </td>
                                <td class="width-24-rem text-left">
                                    ...
                                    <a href="{{ route('admin.market.payment.paid' , $payment->id) }}" class="btn btn-success btn-sm"><i class="fa fa-check"></i>پرداخت شده</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
