                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($order->orderItems as $item)
                            <tr>
                                ...
                                <td>
                                    @forelse($item->orderItemSelectedAttributes as $attribute)
                                        {{ $attribute->categoryAttribute->name }}
                                        :
                                        @if(!empty(json_decode($attribute->categoryValue->value)->value))
                                            {{ json_decode($attribute->categoryValue->value)->value . ' ' . $attribute->categoryAttribute->unit }} |
                                        @endif
