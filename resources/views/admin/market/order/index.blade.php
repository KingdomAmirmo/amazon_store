                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($orders as $order)
                            <tr>
                                ...
                                <td>{{ $order->order_total_products_discount_amount ? $order->order_total_products_discount_amount . 'تومان' : '-' }} </td>
                                ...
                                <td class="width-8-rem text-left">
                                    <div class="dropdown">
                                        <a href="" class="btn btn-success btn-sm btn-block dropdown-toggle" role="button" id="dropdownMenuLink"
