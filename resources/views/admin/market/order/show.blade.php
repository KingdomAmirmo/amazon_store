                        ...
                        <tbody>
                            <tr class="table-primary">
                                ...
                                <td class="width-9-rem text-left">
                                    ...
                                    <a href="{{ route('admin.market.order.show.detail', $order->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-book"></i> جزئیات سفارش</a>
                                </td>
                            </tr>
                            ...
                            <tr class="border-bottom">
                                <th>استان</th>
                                <td class="text-left font-weight-bolder">
                                    {{ $order->address->city->province->name ?? '-' }}</td>
                            </tr>
                            <tr class="border-bottom">
                                <th>شهر</th>
                                <td class="text-left font-weight-bolder">
                            ...
                            <tr class="border-bottom">
                                ...
                                <td class="text-left font-weight-bolder">
                                    {{ $order->address->recipient_last_name ?? '-' }}</td>
                            </tr>
                            <tr class="border-bottom">
                                <th>شماره موبایل</th>
                                <td class="text-left font-weight-bolder">
                            ...
                            <tr class="border-bottom">
                                <th>مبلغ ارسال</th>
                                <td class="text-left font-weight-bolder">
                                    {{ $order->delivery_amount ? $order->delivery_amount . 'تومان' : '-' }}
                                </td>
                            </tr>
                            <tr class="border-bottom">
                                <th>وضعیت ارسال</th>
                            ...
                            <tr class="border-bottom">
                                <th>تاریخ ارسال</th>
                                <td class="text-left font-weight-bolder">
                                    {{ jalaiDate($order->delivery_date) }}
                                </td>
                            </tr>
                            <tr class="border-bottom">
                                <th>مجموع مبلغ سفارش (بدون احتساب تخفیف)</th>
                                <td class="text-left font-weight-bolder">
                                    {{ $order->order_final_amount ? $order->order_final_amount . 'تومان' : '-' }}
                                </td>
                            </tr>
                            <tr class="border-bottom">
                                <th>مجموع تمامی مبلغ تخفیفات</th>
                                <td class="text-left font-weight-bolder">
                                    {{ $order->order_discount_amount ? $order->order_discount_amount . 'تومان' : '-' }}
                                </td>
                            </tr>
                            <tr class="border-bottom">
                                <th>مبلغ تخفیف همه محصولات</th>
                                <td class="text-left font-weight-bolder">
                                    {{ $order->order_total_products_discount_amount ? $order->order_total_products_discount_amount . 'تومان' : '-' }}
                                </td>
                            </tr>
                            <tr class="border-bottom">
                                <th>مبلغ نهایی</th>
                                <td class="text-left font-weight-bolder">
                                    {{ $order->order_final_amount - $order->order_discount_amount ? $order->order_final_amount - $order->order_discount_amount . 'تومان' : '-' }}
                                </td>
                            </tr>
                            <tr class="border-bottom">
                                <th>بانک</th>
