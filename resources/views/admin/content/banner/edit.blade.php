                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control form-control-sm" value="{{ old('title', $banner->title) }}">
                                </div>
                                @error('title')
                            ...
                            <section class="col-12 col-md-6">
                                ...
                                <img src="{{ asset($banner->image) }}" alt="" width="100" height="50" class="mt-3" a>
                                @error('image')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
                                    {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="position" id="" class="form-control form-control-sm">
                                        @foreach($positions as $key => $value)
                                            <option value="{{ $key }}" @if($banner->position == $key) selected @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('position')
