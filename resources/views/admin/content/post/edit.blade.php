                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control form-control-sm" value="{{ old('title', $post->title) }}">
                                </div>
                                @error('title')
...
{{--                                    <img src="{{ asset($post->image['indexArray'][$post->image['currentimage']] ) }}" alt="" width="100" height="50" class="mt-3" a>--}}
                                </div>
                                @error('image')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="published_at" id="published_at" class="form-control form-control-sm d-none" value="{{ $post->published_at }}">
