...
<aside id="sidebar" class="sidebar col-md-3">
    ...
    <section class="content-wrapper bg-white p-3 rounded-2 mb-3">
        ...
        <section class="sidebar-nav">
            ...
            <section class="sidebar-nav-item">
                <span class="sidebar-nav-item-title"><a class="p-3" href="{{ route('customer.profile.my-compares') }}">لیست مقایسه من</a></span>
            </section>
            <section class="sidebar-nav-item">
                <span class="sidebar-nav-item-title"><a class="p-3" href="{{ route('customer.profile.my-favorites') }}">لیست علاقه مندی</a></span>
            </section>
            <section class="sidebar-nav-item">
                <span class="sidebar-nav-item-title"><a class="p-3" href="{{ route('customer.profile.my-tickets') }}">مدیریت تیکت ها</a></span>
            </section>
            <section class="sidebar-nav-item">
                <span class="sidebar-nav-item-title"><a class="p-3" href="{{ route('customer.profile.profile') }}">ویرایش حساب</a></span>
            </section>
            <section class="sidebar-nav-item">
