                    ...
                    <section class="header-cart d-inline ps-3 border-start position-relative">
                        ...
                        <section class="header-cart-dropdown">
                                ...
                                @foreach($cartItems as $cartItem)
                                    ...
                                    <section class="header-cart-dropdown-body-item d-flex justify-content-start align-items-center">
                                        ...
                                        <section class="w-100 text-truncate">
                                            <a class="text-decoration-none text-dark" href="{{ route('customer.market.product', $cartItem->product) }}">{{ $cartItem->product->name }}</a>
                                            <span class="">
                                        ...
                                        <br>
                                        <section class="flex-shrink-1"><a class="text-muted text-decoration-none p-1" href="{{ route('customer.sales-process.remove-from-cart', $cartItem) }}">
                            ...
                            <section class="header-cart-dropdown-footer border-top d-flex justify-content-between align-items-center p-2">
                                ...
                                <section class=""><a class="btn btn-danger btn-sm d-block" href="{{ route('customer.sales-process.address-and-delivery') }}">ثبت سفارش</a></section>
                            </section>
                        </section>
                    </section>
                    @endauth
        ...
        <section class="container-xxl ">
            <nav class="">
                <section class="d-none d-md-flex justify-content-md-start position-relative">
                    ...
                    <section class="navbar-item"><a href="{{ route('customer.products') }}">محصولات</a></section>
