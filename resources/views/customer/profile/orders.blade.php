                ...
                <main id="main-body" class="main-body col-md-9">
                    <section class="content-wrapper bg-white p-3 rounded-2 mb-2">
                        ...
                        <section class="d-flex justify-content-center my-4">
                            ...
                            <a class="btn btn-warning btn-sm mx-1" href="{{ route('customer.profile.orders', 'type=1') }}">درانتظار تایید</a>
                            ...
                            @forelse($orders as $order)
                                <section class="order-item">
                                    <section class="d-flex justify-content-between">
                                        <section>
                                            <section class="order-item-date"><i class="fa fa-calendar-alt"></i>{{ jalaiDate($order->created_at) }}</section>
                                            ...
                                            <section class="order-item-products">
                                                @foreach($order->orderItems as $item)
                                                        <a href="{{ route('customer.market.product', $item->singleProduct->slog) }}"><img src="{{ asset(json_decode($item->product)->image->indexArray->medium) }}" alt=""></a>
                                                @endforeach
                                            </section>
                                        </section>
