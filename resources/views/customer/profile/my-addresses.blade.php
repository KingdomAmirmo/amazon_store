                        ...
                        <section class="address-select">
                            ...
                            @forelse (auth()->user()->addresses as $address)
                                ...
                                <label for="a{{ $address->id }}" class="address-wrapper mb-2 p-2">
                                    ...
                                    <section class="mb-2">
                                        <i class="fa fa-laptop-code mx-1"></i>
                                ...
                                <section class="modal fade" id="edit-address-{{ $address->id }}" tabindex="-1" style="z-index: 999999999999999"
                                                ...
                                                <form class="row" method="post" action="{{ route('customer.sales-process.update-address', $address->id) }}">
                                                    ...
                                                    <section class="col-6 mb-2">
                                                        ...
                                                        <select name="province_id"
                                                            ...
                                                            <option selected>استان موردنظر را انتخاب کنید</option>
