                            ...
                            <section class="content-wrapper bg-white p-3 rounded-2 mb-4">
                                ...
                                <section class="payment-select">
                                    ...
                                    <section class="payment-alert alert alert-primary d-flex align-items-center p-2" role="alert">
                                        <i class="fa fa-info-circle flex-shrink-0 me-2"></i>
                                        <secrion>
                                            برای افزایش هرچه بیشتر سرعت ثبت سفارش و ارسال محصول روش پرداخت آنلاین را انتخاب کنید.
                                        </secrion>
                                    </section>
                            ...
                            <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                ...
                                @foreach ($cartItems as $cartItem)
                                    @php
                                        ...
                                        $productsDiscount = $order->order_discount_amount + $order->order_copan_discount_amount + $order->order_common_discount_amount;
                                    @endphp
                                @endforeach
                                ...
                                @if ($totalDiscount != 0)
                                    <section class="d-flex justify-content-between align-items-center border-bottom">
                                        <p class="text-muted">مجموع تخفیف کالاها</p>
                                        <p class="text-danger fw-bolder"><span
                                                id="total_discount">{{ priceFormat($productsDiscount) }}</span> تومان</p>
                                    </section>
                                @endif
